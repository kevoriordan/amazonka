...
--
--
-- For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CWL_QuerySyntax.html CloudWatch Logs Insights Query Syntax> .
--
module Network.AWS.CloudWatchLogs.StartQuery
    (
    -- * Creating a Request
...
--
-- * 'sqStartTime' - The beginning of the time range to query. Specified as epoch time, the number of seconds since January 1, 1970, 00:00:00 UTC.
--
-- * 'sqEndTime' - The end of the time range to query. Specified as epoch time, the number of seconds since January 1, 1970, 00:00:00 UTC.
--
-- * 'sqQueryString' - The query string to use. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CWL_QuerySyntax.html CloudWatch Logs Insights Query Syntax> .
startQuery
    :: Text -- ^ 'sqLogGroupName'
    -> Natural -- ^ 'sqStartTime'
    -> Natural -- ^ 'sqEndTime'
...
-- | The query string to use. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CWL_QuerySyntax.html CloudWatch Logs Insights Query Syntax> .
