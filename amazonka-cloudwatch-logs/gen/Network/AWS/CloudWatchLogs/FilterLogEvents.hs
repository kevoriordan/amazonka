...
--
-- * 'fleFilterPattern' - The filter pattern to use. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/FilterAndPatternSyntax.html Filter and Pattern Syntax> . If not provided, all the events are matched.
--
...
-- | The filter pattern to use. For more information, see <http://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/FilterAndPatternSyntax.html Filter and Pattern Syntax> . If not provided, all the events are matched.
