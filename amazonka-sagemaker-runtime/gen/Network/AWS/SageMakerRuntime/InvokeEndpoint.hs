...
--
-- * 'ieBody' - Provides input data, in the format specified in the @ContentType@ request header. Amazon SageMaker passes all of the data in the body to the model.  For information about the format of the request body, see <http://docs.aws.amazon.com/sagemaker/latest/dg/cdf-inference.html Common Data Formats—Inference> .
invokeEndpoint
    :: Text -- ^ 'ieEndpointName'
    -> ByteString -- ^ 'ieBody'
    -> InvokeEndpoint
...
-- | Provides input data, in the format specified in the @ContentType@ request header. Amazon SageMaker passes all of the data in the body to the model.  For information about the format of the request body, see <http://docs.aws.amazon.com/sagemaker/latest/dg/cdf-inference.html Common Data Formats—Inference> .
...
data InvokeEndpointResponse = InvokeEndpointResponse'
  ...
  , _iersCustomAttributes         :: !(Maybe (Sensitive Text))
...
--
-- * 'iersBody' - Includes the inference provided by the model. For information about the format of the response body, see <http://docs.aws.amazon.com/sagemaker/latest/dg/cdf-inference.html Common Data Formats—Inference> .
invokeEndpointResponse
...
-- | Includes the inference provided by the model. For information about the format of the response body, see <http://docs.aws.amazon.com/sagemaker/latest/dg/cdf-inference.html Common Data Formats—Inference> .
