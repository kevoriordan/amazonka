...
--
-- * 'bdrDeploymentStatus' - The current status of the group deployment: ''Pending'', ''InProgress'', ''Success'', or ''Failure''.
--
...
newtype FunctionDefaultExecutionConfig = FunctionDefaultExecutionConfig'
...
functionDefaultExecutionConfig
    :: FunctionDefaultExecutionConfig
functionDefaultExecutionConfig =
  FunctionDefaultExecutionConfig' {_fdecIsolationMode = Nothing}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'fdvDefaultConfig' - Default configuration that will apply to all Lambda functions in this function definition version
--
