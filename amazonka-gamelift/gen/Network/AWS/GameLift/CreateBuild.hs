...
--
--
-- Game server binaries must be combined into a @.zip@ file for use with Amazon GameLift. See <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-build-intro.html Uploading Your Game> for more information.
--
-- /Important:/ To create new builds quickly and easily, use the AWS CLI command __<https://docs.aws.amazon.com/cli/latest/reference/gamelift/upload-build.html upload-build> __ . This helper command uploads your build and creates a new build record in one step, and automatically handles the necessary permissions. See <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-build-cli-uploading.html Upload Build Files to Amazon GameLift> for more help.
--
