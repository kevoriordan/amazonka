...
--
-- * 'icvccrlCertificateRevocationList' - The client certificate revocation list file. For more information, see <vpn/latest/clientvpn-admin/cvpn-working-certificates.html#cvpn-working-certificates-generate Generate a Client Certificate Revocation List> in the /AWS Client VPN Admin Guide/ .
importClientVPNClientCertificateRevocationList
...
-- | The client certificate revocation list file. For more information, see <vpn/latest/clientvpn-admin/cvpn-working-certificates.html#cvpn-working-certificates-generate Generate a Client Certificate Revocation List> in the /AWS Client VPN Admin Guide/ .
