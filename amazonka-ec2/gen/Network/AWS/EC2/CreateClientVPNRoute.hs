...
--
-- * 'ccvrTargetVPCSubnetId' - The ID of the subnet through which you want to route traffic. The specified subnet must be an existing target network of the Client VPN endpoint.
createClientVPNRoute
