...
--
-- * 'ccveServerCertificateARN' - The ARN of the server certificate. For more information, see the <acm/latest/userguide/acm-overview.html AWS Certificate Manager User Guide> .
--
...
-- | The ARN of the server certificate. For more information, see the <acm/latest/userguide/acm-overview.html AWS Certificate Manager User Guide> .
