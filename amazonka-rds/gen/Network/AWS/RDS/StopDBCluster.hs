...
--
--
-- For more information, see <http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-cluster-stop-start.html Stopping and Starting an Aurora Cluster> in the /Amazon Aurora User Guide./
--
module Network.AWS.RDS.StopDBCluster
    (
    -- * Creating a Request
