...
--
--
-- For more information about how batch transformation works Amazon SageMaker, see <http://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform.html How It Works> .
--
module Network.AWS.SageMaker.CreateTransformJob
    (
    -- * Creating a Request
...
--
-- * 'ctjBatchStrategy' - Determines the number of records to include in a mini-batch. If you want to include only one record in a mini-batch, specify @SingleRecord@ .. If you want mini-batches to contain a maximum of the number of records specified in the @MaxPayloadInMB@ parameter, specify @MultiRecord@ . If you set @SplitType@ to @Line@ and @BatchStrategy@ to @MultiRecord@ , a batch transform automatically splits your input data into the specified payload size. There's no need to split the dataset into smaller files or to use larger payload sizes unless the records in your dataset are very large.
--
...
--
-- * 'ctjTags' - (Optional) An array of key-value pairs. For more information, see <http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what Using Cost Allocation Tags> in the /AWS Billing and Cost Management User Guide/ .
--
...
-- | (Optional) An array of key-value pairs. For more information, see <http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what Using Cost Allocation Tags> in the /AWS Billing and Cost Management User Guide/ .
