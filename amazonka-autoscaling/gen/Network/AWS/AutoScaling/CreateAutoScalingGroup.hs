...
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/AutoScalingGroup.html Auto Scaling Groups> in the /Amazon EC2 Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.CreateAutoScalingGroup
    (
    -- * Creating a Request
...
--
-- * 'casgHealthCheckGracePeriod' - The amount of time, in seconds, that Amazon EC2 Auto Scaling waits before checking the health status of an EC2 instance that has come into service. During this time, any health check failures for the instance are ignored. The default is 0. This parameter is required if you are adding an @ELB@ health check. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/healthcheck.html Health Checks> in the /Amazon EC2 Auto Scaling User Guide/ .
--
-- * 'casgServiceLinkedRoleARN' - The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other AWS services on your behalf. By default, Amazon EC2 Auto Scaling uses a service-linked role named AWSServiceRoleForAutoScaling, which it creates if it does not exist.
--
...
--
-- * 'casgDefaultCooldown' - The amount of time, in seconds, after a scaling activity completes before another scaling activity can start. The default is 300. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html Scaling Cooldowns> in the /Amazon EC2 Auto Scaling User Guide/ .
--
...
--
-- * 'casgMixedInstancesPolicy' - The mixed instances policy to use to launch instances. This parameter, a launch template, a launch configuration, or an EC2 instance must be specified.
--
-- * 'casgLaunchConfigurationName' - The name of the launch configuration. This parameter, a launch template, a mixed instances policy, or an EC2 instance must be specified.
--
...
--
-- * 'casgLaunchTemplate' - The launch template to use to launch instances. This parameter, a launch configuration, a mixed instances policy, or an EC2 instance must be specified.
--
-- * 'casgPlacementGroup' - The name of the placement group into which to launch your instances, if any. For more information, see <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html Placement Groups> in the /Amazon Elastic Compute Cloud User Guide/ .
--
-- * 'casgLoadBalancerNames' - One or more Classic Load Balancers. To specify an Application Load Balancer, use @TargetGroupARNs@ instead. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-from-instance.html Using a Load Balancer With an Auto Scaling Group> in the /Amazon EC2 Auto Scaling User Guide/ .
--
-- * 'casgTags' - One or more tags. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-tagging.html Tagging Auto Scaling Groups and Instances> in the /Amazon EC2 Auto Scaling User Guide/ .
--
...
-- | One or more Classic Load Balancers. To specify an Application Load Balancer, use @TargetGroupARNs@ instead. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-from-instance.html Using a Load Balancer With an Auto Scaling Group> in the /Amazon EC2 Auto Scaling User Guide/ .
...
-- | One or more tags. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-tagging.html Tagging Auto Scaling Groups and Instances> in the /Amazon EC2 Auto Scaling User Guide/ .
