...
--
-- * 'socSSECustomerAlgorithm' - The SSE Algorithm used to encrypt the object. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
--
-- * 'socSSECustomerKey' - The SSE Customer Key. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
--
-- * 'socRequestProgress' - Specifies if periodic request progress information should be enabled.
--
-- * 'socSSECustomerKeyMD5' - The SSE Customer Key MD5. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
--
...
-- | The SSE Algorithm used to encrypt the object. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
...
-- | The SSE Customer Key. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
...
-- | The SSE Customer Key MD5. For more information, see <http://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html Server-Side Encryption (Using Customer-Provided Encryption Keys> .
