...
--
-- * 'dsmrsDefinition' - The Amazon States Language definition of the state machine. See <http://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html Amazon States Language> .
--
