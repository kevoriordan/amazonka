...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'heTaskSubmitFailedEventDetails' - Undocumented member.
--
-- * 'heTaskStartedEventDetails' - Undocumented member.
--
-- * 'heActivityStartedEventDetails' - Undocumented member.
--
-- * 'heTaskSubmittedEventDetails' - Undocumented member.
--
...
--
-- * 'heTaskStartFailedEventDetails' - Undocumented member.
--
...
--
-- * 'heTaskScheduledEventDetails' - Undocumented member.
--
...
--
-- * 'heTaskFailedEventDetails' - Undocumented member.
--
