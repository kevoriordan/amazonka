...
--
-- Polling with @GetActivityTask@ can cause latency in some implementations. See <http://docs.aws.amazon.com/step-functions/latest/dg/bp-activity-pollers.html Avoid Latency When Polling for Activity Tasks> in the Step Functions Developer Guide.
--
module Network.AWS.StepFunctions.GetActivityTask
    (
    -- * Creating a Request
