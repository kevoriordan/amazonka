...
-- | You've exceeded the number of tags allowed for a resource. See the <http://docs.aws.amazon.com/step-functions/latest/dg/limits.html Limits Topic> in the AWS Step Functions Developer Guide.
--
--
