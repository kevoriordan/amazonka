...
data CreateSecurityConfiguration = CreateSecurityConfiguration'
  { _cscName                    :: !Text
  , _cscEncryptionConfiguration :: !EncryptionConfiguration
...
createSecurityConfiguration
    :: Text -- ^ 'cscName'
    -> EncryptionConfiguration -- ^ 'cscEncryptionConfiguration'
    -> CreateSecurityConfiguration
createSecurityConfiguration pName_ pEncryptionConfiguration_ =
  CreateSecurityConfiguration'
    {_cscName = pName_, _cscEncryptionConfiguration = pEncryptionConfiguration_}
...
data CreateSecurityConfigurationResponse = CreateSecurityConfigurationResponse'
  { _cscrsName             :: !(Maybe Text)
  , _cscrsCreatedTimestamp :: !(Maybe POSIX)
