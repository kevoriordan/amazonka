...
data PutDataCatalogEncryptionSettings = PutDataCatalogEncryptionSettings'
  { _pdcesCatalogId                     :: !(Maybe Text)
  , _pdcesDataCatalogEncryptionSettings :: !DataCatalogEncryptionSettings
...
--
-- * 'pdcesCatalogId' - The ID of the Data Catalog for which to set the security configuration. If none is supplied, the AWS account ID is used by default.
--
-- * 'pdcesDataCatalogEncryptionSettings' - The security configuration to set.
putDataCatalogEncryptionSettings
    :: DataCatalogEncryptionSettings -- ^ 'pdcesDataCatalogEncryptionSettings'
    -> PutDataCatalogEncryptionSettings
putDataCatalogEncryptionSettings pDataCatalogEncryptionSettings_ =
  PutDataCatalogEncryptionSettings'
    { _pdcesCatalogId = Nothing
    , _pdcesDataCatalogEncryptionSettings = pDataCatalogEncryptionSettings_
    }
...
instance AWSRequest PutDataCatalogEncryptionSettings
         where
...
instance ToHeaders PutDataCatalogEncryptionSettings
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON PutDataCatalogEncryptionSettings
         where
...
instance ToPath PutDataCatalogEncryptionSettings
         where
        toPath = const "/"

instance ToQuery PutDataCatalogEncryptionSettings
         where
...
putDataCatalogEncryptionSettingsResponse
    :: Int -- ^ 'pdcesrsResponseStatus'
    -> PutDataCatalogEncryptionSettingsResponse
putDataCatalogEncryptionSettingsResponse pResponseStatus_ =
  PutDataCatalogEncryptionSettingsResponse'
    {_pdcesrsResponseStatus = pResponseStatus_}
