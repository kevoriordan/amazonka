...
getSecurityConfigurations
    :: GetSecurityConfigurations
getSecurityConfigurations =
  GetSecurityConfigurations' {_gscNextToken = Nothing, _gscMaxResults = Nothing}
...
instance AWSPager GetSecurityConfigurations where
        page rq rs
          ...
          | otherwise =
            Just $ rq & gscNextToken .~ rs ^. gscsrsNextToken
...
instance Hashable GetSecurityConfigurations where

instance NFData GetSecurityConfigurations where
...
data GetSecurityConfigurationsResponse = GetSecurityConfigurationsResponse'
  { _gscsrsSecurityConfigurations :: !(Maybe [SecurityConfiguration])
  , _gscsrsNextToken              :: !(Maybe Text)
...
getSecurityConfigurationsResponse pResponseStatus_ =
  GetSecurityConfigurationsResponse'
    { _gscsrsSecurityConfigurations = Nothing
