...
--
-- * 'ccClassifiers' - A list of custom classifiers that the user has registered. By default, all built-in classifiers are included in a crawl, but these custom classifiers always override the default classifiers for a given classification.
--
-- * 'ccCrawlerSecurityConfiguration' - The name of the SecurityConfiguration structure to be used by this Crawler.
--
-- * 'ccConfiguration' - Crawler configuration information. This versioned JSON string allows users to specify aspects of a crawler's behavior. For more information, see <http://docs.aws.amazon.com/glue/latest/dg/crawler-configuration.html Configuring a Crawler> .
--
...
ccCrawlerSecurityConfiguration :: Lens' CreateCrawler (Maybe Text)
              ...
              (catMaybes
                 [("SchemaChangePolicy" .=) <$> _ccSchemaChangePolicy,
                  ...
                  ("CrawlerSecurityConfiguration" .=) <$>
                    _ccCrawlerSecurityConfiguration,
