...
getSecurityConfiguration
    :: Text -- ^ 'gscName'
    -> GetSecurityConfiguration
getSecurityConfiguration pName_ = GetSecurityConfiguration' {_gscName = pName_}
...
instance AWSRequest GetSecurityConfiguration where
        type Rs GetSecurityConfiguration =
             GetSecurityConfigurationResponse
...
instance Hashable GetSecurityConfiguration where

instance NFData GetSecurityConfiguration where
...
data GetSecurityConfigurationResponse = GetSecurityConfigurationResponse'
  { _gscrsSecurityConfiguration :: !(Maybe SecurityConfiguration)
...
getSecurityConfigurationResponse pResponseStatus_ =
  GetSecurityConfigurationResponse'
    { _gscrsSecurityConfiguration = Nothing
