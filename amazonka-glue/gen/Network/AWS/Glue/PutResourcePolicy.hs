...
data PutResourcePolicy = PutResourcePolicy'
  { _prpPolicyExistsCondition :: !(Maybe ExistCondition)
...
--
-- * 'prpPolicyHashCondition' - This is the hash value returned when the previous policy was set using PutResourcePolicy. Its purpose is to prevent concurrent modifications of a policy. Do not use this parameter if no previous policy has been set.
--
...
putResourcePolicyResponse pResponseStatus_ =
  PutResourcePolicyResponse'
    {_prprsPolicyHash = Nothing, _prprsResponseStatus = pResponseStatus_}
