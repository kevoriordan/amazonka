...
newtype DeleteResourcePolicy = DeleteResourcePolicy'
  { _drpPolicyHashCondition :: Maybe Text
...
deleteResourcePolicy
    :: DeleteResourcePolicy
deleteResourcePolicy = DeleteResourcePolicy' {_drpPolicyHashCondition = Nothing}
...
deleteResourcePolicyResponse pResponseStatus_ =
  DeleteResourcePolicyResponse' {_drprsResponseStatus = pResponseStatus_}
