...
generateTemplate
    :: GenerateTemplate
generateTemplate =
  GenerateTemplate' {_gtAppId = Nothing, _gtTemplateFormat = Nothing}
...
data GenerateTemplateResponse = GenerateTemplateResponse'
  { _gtrsS3Location     :: !(Maybe S3Location)
...
generateTemplateResponse pResponseStatus_ =
  GenerateTemplateResponse'
    {_gtrsS3Location = Nothing, _gtrsResponseStatus = pResponseStatus_}
