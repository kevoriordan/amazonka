...
--
-- * 'gcsAppId' - ID of the application associated with the change set.
--
-- * 'gcsChangesetFormat' - Format for the change set.
generateChangeSet
    :: GenerateChangeSet
generateChangeSet =
  GenerateChangeSet' {_gcsAppId = Nothing, _gcsChangesetFormat = Nothing}
...
data GenerateChangeSetResponse = GenerateChangeSetResponse'
  { _gcsrsS3Location     :: !(Maybe S3Location)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gcsrsS3Location' - Location of the Amazon S3 object.
--
...
generateChangeSetResponse pResponseStatus_ =
  GenerateChangeSetResponse'
    {_gcsrsS3Location = Nothing, _gcsrsResponseStatus = pResponseStatus_}
